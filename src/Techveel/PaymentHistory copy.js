...
const PaymentHistory = () => {
  ...
  const handleDownloadExcel = () => {
    ...
    XLSX.writeFile(workbook, `PaymentsHistoryData+${currentDate}+.xlsx`);
  };
  ...
  const handleEdit = (pay) => {
    ...
    console.log('balance now', pay.NetAmount - pay.TotalPaidAmount + pay.PaidAmount);
              ...
              <Stack direction={'column'} spacing={2} p={2}>
                <TextField
                  ...
                  onChange={(e) => {
                    ...
                    console.log('setBalanceOnDate: ', balance - newValue);
                    setFieldErrors((prevFieldErrors) => ({
                      ...prevFieldErrors,
                      paidFee: newValue.trim() === '' || newValue <= 0,
                      // overBalance: newValue > balance,
                    }));
                  }}
                  ...
                  helperText={
                    fieldErrors.paidFee
                      ...
                      : fieldErrors.overBalance && `Cannot exceed the balance fee ₹ ${balance} on this record `
                  }
                />
                <TextField
                  size="small"
